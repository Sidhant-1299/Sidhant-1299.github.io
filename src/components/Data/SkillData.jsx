...
import matlplotlib from "../../assets/Skills/matlplotlib.png";
...
export const header = "Skill Highlights";
...
export const skills = [
  ...
  { icon: Git, name: "Git", homepage: "https://git-scm.com/" },
  { icon: linux, name: "Linux", homepage: "https://www.linux.org/" },
  {
    icon: excel,
    name: "Excel",
